...
void texture_systeme_opengl_blit(GLuint opengl_indice,
...
void texture_systeme_opengl_blit2d_etirer(GLuint opengl_indice, 
...
void texture_systeme_opengl_blit2d_repeter(GLuint opengl_indice, 
					   unsigned int x1, unsigned int y1, 
					   unsigned int x2, unsigned int y2,
...
GLuint texture_systeme_opengl_charger(unsigned int width, unsigned int height, unsigned int w2, unsigned int h2, unsigned int bpp, void * pixels) {
  ...
  // On donne a OpenGL la texture munie de quoi la lire.
  /* 
